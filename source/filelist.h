...
extern const u8		wall_jpg[];
extern const u32	wall_jpg_size;
...
extern const u8		chess_classic_png[];
extern const u32	chess_classic_png_size;

extern const u8		move_pcm[];
extern const u32	move_pcm_size;
